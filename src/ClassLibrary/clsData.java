...
public class clsData {
    ...
    public  int MaximumNumberOfVerticesOfTypeZ[] =new int[NumberOfVerticesOfTypeZ];
    ...
    clsData(int aNumberOfTours,int aNumberOfVertices,int aNumberOfPersons,int aMinimumNumberOfPersonsInSubgroup,
            int aBudgetLimitation,int aMaximumNumberOfVerticesOfTypeZ[],float aStartPoint [],float aPOI[][]){
    ...
    public  int getNumberOfPersons(){
     ...
     public int getBudgetLimitation(){
   ...
   public  int [] getMaximumNumberOfVerticesOfTypeZ(){
