...
public class clsGroupTrip {
    ...
    clsData getDataForTouristicGroup(clsGroupData groupdata,ArrayList<Integer> TouristicGroup ){
        ...
        int MinimalBudgetLimitation=this.getMinimumBudgetLimitation(TouristicGroup, groupdata.Person);
        int NumberOfVerticesOfTypeZ[]=this.getMinimumNumberOfVerticesOfTypeZ(groupdata.Person, TouristicGroup);
    ...
    int getMinimumBudgetLimitation(ArrayList<Integer> TouristicGroup,int Person[][]){
        int Min=Person[TouristicGroup.get(0)][1];
    ...
    int [] getMinimumNumberOfVerticesOfTypeZ( int Person[][],ArrayList<Integer> TouristicGroup){
        int result[]=new int [10];
        for(int i=0;i<result.length;i++){
            int Min= Person[TouristicGroup.get(0)][i+2+2*(Person.length-1)];
